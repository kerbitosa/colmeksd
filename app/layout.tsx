...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://colmeksd.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Bocil Jepang Ngentot Jav Jilbab Smp Barat Mama Viral Sma Korea Tante China Live Paksa Bokep Abg Terbaru`,
        "logo": "https://colmeksd.pages.dev/favicon.ico",
        "url": "https://colmeksd.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://colmeksd.pages.dev"
        ...
        "url": "https://colmeksd.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Bocil Jepang Ngentot Jav Jilbab Smp Barat Mama Viral Sma Korea Tante China Live Paksa Bokep Abg Terbaru`,
        "image": "https://colmeksd.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://colmeksd.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://colmeksd.pages.dev/?q={search_term}", 
